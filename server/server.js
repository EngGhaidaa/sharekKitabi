...
Meteor.startup(function() {
	...
	{var i = 0
		...
		while(i<10)
		{ var bookid = Books.insert({title:('كتاب' + i),author:('مؤلف ' + i),publisher:('ناشر' + i),
			numberOfPages:(i),summary:'dadada',categorie:categoriesArray[i]._id,
			insurance:'2',purchasing:'0',rent:'21',rentTime:'12', purch:true,
			copiesPurchas:'0',copiesRent:'12',rack:(i),source:('شارك كتابي'),rating:"1"}, function (err,result) {
            if(!err){
