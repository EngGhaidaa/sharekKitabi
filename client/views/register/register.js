...
Template.Register.events({
    'submit #register_form': function (e, t) {
        ...
        var register_password_again = t.find('#register_password_again').value;
        ...
        if (!isValidPassword(register_password, min_password_len)) {
            ...
            if(register_password != register_password_again){
                pageSession.set("errorMessage", "عذراً .. كلمتا السر غير متطابقتين ");
                t.find('#register_password').focus();
            }
            return false;
        }
